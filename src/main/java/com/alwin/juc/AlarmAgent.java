...
public class AlarmAgent {
     ...
     * blocker对象
     */
    private final Blocker blocker = new ConditionVarBlocker(false);
    ...
    public void init() {
        ...
        // 每5s执行一次
        heartbeatExecutor.scheduleAtFixedRate(new HeartbeatTask(), 2000, 2000, TimeUnit.MILLISECONDS);
